...
class resultClass:
    def __init__(self, root):
        ...
        ####################     image  ########################
        self.bg_img=Image.open("Image/results.jpg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                messagebox.showerror("Error", "Please first select student", parent=self.root
                row=cur.fetchone()
                if row!=None:
