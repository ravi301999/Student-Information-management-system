...
class Register:
    def __init__(self, root):
        ...
        #################    big Image
        self.bg=ImageTk.PhotoImage(file="image/big.jfif")
        bg=Label(self.root, image=self.bg).place(x=250, y=0, relwidth=1, relheight=1)


        #################    left Image
        self.left=ImageTk.PhotoImage(file="image/left - Copy.jfif")
        ...
        self.btn_img=ImageTk.PhotoImage(file="image/register.jfif")
